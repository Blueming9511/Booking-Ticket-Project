...
public class VNPayService {
    ...
    public Map<String, String> init(PaymentInitRequestDto request) throws UnsupportedEncodingException {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String vnp_OrderInfo = "Thanh toan don hang: " + request.getRequestId();
        ...
        return Map.of(
            "url", Config.vnp_PayUrl + "?" + queryUrl,
