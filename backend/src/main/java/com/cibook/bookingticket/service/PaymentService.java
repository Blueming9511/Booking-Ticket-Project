...
public class PaymentService implements IService<Payment, String> {
        ...
        public Map<String, Double> getRevenueStatAMonth() {
                ...
                return Map.of(
                                ...
                                "lastMonth",
                                getTotalRevenueAMonth(now.withDayOfMonth(1).minusMonths(1), now.minusMonths(1)));
        }
        ...
        private int getTotalConversionByMonth(LocalDateTime startMonth, LocalDateTime endMonth, PaymentStatus status) {
                ...
                if (startMonth != null && endMonth != null) {
                        query.addCriteria(
                                        Criteria.where("date")
                                                        .gte(Date.from(startMonth.atZone(ZoneId.systemDefault())
                                                                        .toInstant()))
                                                        .lte(Date.from(endMonth.atZone(ZoneId.systemDefault())
                                                                        .toInstant())));
                } else if (startMonth != null) {
                        query.addCriteria(
                                        Criteria.where("date").gte(Date
                                                        .from(startMonth.atZone(ZoneId.systemDefault()).toInstant())));
                } else if (endMonth != null) {
                        query.addCriteria(
                                        Criteria.where("date").lte(Date
                                                        .from(endMonth.atZone(ZoneId.systemDefault()).toInstant())));
                }
        ...
        public Map<String, Double> getConversionRate() {
                ...
                long lastMonthApproved = getTotalConversionByMonth(lastMonthStart, lastMonthEnd,
        ...
        public List<RevenueDTO> getRevenueByWeek() {
                Aggregation aggregation = Aggregation.newAggregation(
                                ...
                                Aggregation.project()
                                                .and("revenue").as("revenue")
                                                .andExpression("concat('Week ', toString(week(date)), ' ', toString(year(date)))")
                                                .as("period"),
                                Aggregation.group("period")
                                                .sum("revenue").as("revenue")
                                                .count().as("orders"),
        ...
        public List<RecentBookingsDto> getRecentBookings() {
                Aggregation aggregation = Aggregation.newAggregation(
                                ...
                                Aggregation.project()
                                                ...
                                                .andExpression("dateToString('%Y-%m-%d %H:%M:%S', date)")
                                                .as("bookingDate")
