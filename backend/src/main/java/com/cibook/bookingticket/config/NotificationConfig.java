...
public class NotificationConfig {
    ...
    public NotificationConfig(NotificationSubject notificationSubject, WebSocketNotificationListener webSocketNotificationListener, EmailNotificationListener emailNotificationListener) {
